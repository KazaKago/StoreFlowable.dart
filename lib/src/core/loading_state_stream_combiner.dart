...
extension LoadingStateStreamCombiner<A> on Stream<LoadingState<A>> {
  ...
  Stream<LoadingState<Z>> combineState3<B, C, Z>(Stream<LoadingState<B>> stateStream2, Stream<LoadingState<C>> stateStream3, Z Function(A rawContent1, B rawContent2, C rawContent3) transform) {
  ...
  Stream<LoadingState<Z>> combineState4<B, C, D, Z>(Stream<LoadingState<B>> stateStream2, Stream<LoadingState<C>> stateStream3, Stream<LoadingState<D>> stateStream4, Z Function(A rawContent1, B rawContent2, C rawContent3, D rawContent4) transform) {
  ...
  Stream<LoadingState<Z>> combineState5<B, C, D, E, Z>(Stream<LoadingState<B>> stateStream2, Stream<LoadingState<C>> stateStream3, Stream<LoadingState<D>> stateStream4, Stream<LoadingState<E>> stateStream5, Z Function(A rawContent1, B rawContent2, C rawContent3, D rawContent4, E rawContent5) transform) {
